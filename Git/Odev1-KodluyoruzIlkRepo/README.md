...
## Kullanım
Projeyi bilgisayarımıza kopyaladıktan sorra Visual Studio Code programını açıyoruz.
## Katkı
Pull istekleri (request) için önce konu açınız.
## Lisans (License)
Lisans (License) [MIT License](https://choosealicense.com/licenses/mit/ "License").
